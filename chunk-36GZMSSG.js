...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jt,depthTest:!1,depthWrite:!1})}function nh(){return new et({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:Jt,depthTest:!1,depthWrite:!1})}function ih(){return new et({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
	...
	`}function Up(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){let l=o.mapping,c=l===sa||l===ra,h=l===ui||l===di;if(c||h){let u=e.get(o),f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new Wa(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{let p=o.image;return c&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new Wa(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0,c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){let l=o.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Np(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&Ui("WebGLRenderer: "+n+" extension not supported."),s}}}function Fp(i,e,t,n){let s={},r=new WeakMap;function a(u){let f=u.target;f.index!==null&&e.remove(f.index);for(let x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",a),delete s[f.id];let p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(u,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(u){let f=u.attributes;for(let p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(u){let f=[],p=u.index,x=u.attributes.position,_=0;if(p!==null){let S=p.array;_=p.version;for(let M=0,A=S.length;M<A;M+=3){let w=S[M+0],T=S[M+1],R=S[M+2];f.push(w,T,T,R,R,w)}}else if(x!==void 0){let S=x.array;_=x.version;for(let M=0,A=S.length/3-1;M<A;M+=3){let w=M+0,T=M+1,R=M+2;f.push(w,T,T,R,R,w)}}else return;let m=new(Ko(f)?gs:xs)(f,1);m.version=_;let d=r.get(u);d&&e.remove(d),r.set(u,m)}function h(u){let f=r.get(u);if(f){let p=u.index;p!==null&&f.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Op(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function c(f,p,x){x!==0&&(i.drawElementsInstanced(n,p,r,f*a,x),t.update(p,n,x))}function h(f,p,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,x);let m=0;for(let d=0;d<x;d++)m+=p[d];t.update(m,n,1)}function u(f,p,x,_){if(x===0)return;let m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,_,0,x);let d=0;for(let S=0;S<x;S++)d+=p[S]*_[S];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Bp(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Oe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function zp(i,e,t){let n=new WeakMap,s=new ft;function r(a,o,l){let c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0,f=n.get(o);if(f===void 0||f.count!==u){let v=function(){U.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var p=v;f!==void 0&&f.texture.dispose();let x=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],M=o.morphAttributes.color||[],A=0;x===!0&&(A=1),_===!0&&(A=2),m===!0&&(A=3);let w=o.attributes.position.count*A,T=1;w>e.maxTextureSize&&(T=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);let R=new Float32Array(w*T*4*u),U=new ms(R,w,T,u);U.type=pn,U.needsUpdate=!0;let b=A*4;for(let I=0;I<u;I++){let F=d[I],V=S[I],W=M[I],H=w*T*4*I;for(let Y=0;Y<F.count;Y++){let j=Y*b;x===!0&&(s.fromBufferAttribute(F,Y),R[H+j+0]=s.x,R[H+j+1]=s.y,R[H+j+2]=s.z,R[H+j+3]=0),_===!0&&(s.fromBufferAttribute(V,Y),R[H+j+4]=s.x,R[H+j+5]=s.y,R[H+j+6]=s.z,R[H+j+7]=0),m===!0&&(s.fromBufferAttribute(W,Y),R[H+j+8]=s.x,R[H+j+9]=s.y,R[H+j+10]=s.z,R[H+j+11]=W.itemSize===4?s.w:1)}}f={count:u,texture:U,size:new me(w,T)},n.set(o,f),o.addEventListener("dispose",v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<c.length;m++)x+=c[m];let _=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Vp(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return u}function a(){s=new WeakMap}function o(l){let c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}var Mh=new Cn,sh=new Ts(1,1),Sh=new ms,Th=new wr,Eh=new vs,rh=[],ah=[],oh=new Float32Array(16),lh=new Float32Array(9),ch=new Float32Array(4);function Ki(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=rh[s];if(r===void 0&&(r=new Float32Array(s),rh[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function gt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function _t(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ya(i,e){let t=ah[e];t===void 0&&(t=new Int32Array(e),ah[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function kp(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Gp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2fv(this.addr,e),_t(t,e)}}function Hp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(gt(t,e))return;i.uniform3fv(this.addr,e),_t(t,e)}}function Wp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4fv(this.addr,e),_t(t,e)}}function Xp(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;ch.set(n),i.uniformMatrix2fv(this.addr,!1,ch),_t(t,n)}}function qp(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;lh.set(n),i.uniformMatrix3fv(this.addr,!1,lh),_t(t,n)}}function Yp(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(gt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),_t(t,e)}else{if(gt(t,n))return;oh.set(n),i.uniformMatrix4fv(this.addr,!1,oh),_t(t,n)}}function Zp(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Jp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2iv(this.addr,e),_t(t,e)}}function $p(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(gt(t,e))return;i.uniform3iv(this.addr,e),_t(t,e)}}function Kp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4iv(this.addr,e),_t(t,e)}}function jp(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Qp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(gt(t,e))return;i.uniform2uiv(this.addr,e),_t(t,e)}}function em(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(gt(t,e))return;i.uniform3uiv(this.addr,e),_t(t,e)}}function tm(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(gt(t,e))return;i.uniform4uiv(this.addr,e),_t(t,e)}}function nm(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(sh.compareFunction=Jo,r=sh):r=Mh,t.setTexture2D(e||r,s)}function im(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Th,s)}function sm(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Eh,s)}function rm(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Sh,s)}function am(i){switch(i){case 5126:return kp;case 35664:return Gp;case 35665:return Hp;case 35666:return Wp;case 35674:return Xp;case 35675:return qp;case 35676:return Yp;case 5124:case 35670:return Zp;case 35667:case 35671:return Jp;case 35668:case 35672:return $p;case 35669:case 35673:return Kp;case 5125:return jp;case 36294:return Qp;case 36295:return em;case 36296:return tm;case 35678:case 36198:case 36298:case 36306:case 35682:return nm;case 35679:case 36299:case 36307:return im;case 35680:case 36300:case 36308:case 36293:return sm;case 36289:case 36303:case 36311:case 36292:return rm}}function om(i,e){i.uniform1fv(this.addr,e)}function lm(i,e){let t=Ki(e,this.size,2);i.uniform2fv(this.addr,t)}function cm(i,e){let t=Ki(e,this.size,3);i.uniform3fv(this.addr,t)}function hm(i,e){let t=Ki(e,this.size,4);i.uniform4fv(this.addr,t)}function um(i,e){let t=Ki(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function dm(i,e){let t=Ki(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function fm(i,e){let t=Ki(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function pm(i,e){i.uniform1iv(this.addr,e)}function mm(i,e){i.uniform2iv(this.addr,e)}function xm(i,e){i.uniform3iv(this.addr,e)}function gm(i,e){i.uniform4iv(this.addr,e)}function _m(i,e){i.uniform1uiv(this.addr,e)}function vm(i,e){i.uniform2uiv(this.addr,e)}function ym(i,e){i.uniform3uiv(this.addr,e)}function bm(i,e){i.uniform4uiv(this.addr,e)}function Mm(i,e,t){let n=this.cache,s=e.length,r=Ya(t,s);gt(n,r)||(i.uniform1iv(this.addr,r),_t(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||Mh,r[a])}function Sm(i,e,t){let n=this.cache,s=e.length,r=Ya(t,s);gt(n,r)||(i.uniform1iv(this.addr,r),_t(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Th,r[a])}function Tm(i,e,t){let n=this.cache,s=e.length,r=Ya(t,s);gt(n,r)||(i.uniform1iv(this.addr,r),_t(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Eh,r[a])}function Em(i,e,t){let n=this.cache,s=e.length,r=Ya(t,s);gt(n,r)||(i.uniform1iv(this.addr,r),_t(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Sh,r[a])}function Am(i){switch(i){case 5126:return om;case 35664:return lm;case 35665:return cm;case 35666:return hm;case 35674:return um;case 35675:return dm;case 35676:return fm;case 5124:case 35670:return pm;case 35667:case 35671:return mm;case 35668:case 35672:return xm;case 35669:case 35673:return gm;case 5125:return _m;case 36294:return vm;case 36295:return ym;case 36296:return bm;case 35678:case 36198:case 36298:case 36306:case 35682:return Mm;case 35679:case 36299:case 36307:return Sm;case 35680:case 36300:case 36308:case 36293:return Tm;case 36289:case 36303:case 36311:case 36292:return Em}}var hl=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=am(t.type)}},ul=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Am(t.type)}},dl=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},cl=/(\w+)(\])?(\[|\.)?/g;function hh(i,e){i.seq.push(e),i.map[e.id]=e}function wm(i,e,t){let n=i.name,s=n.length;for(cl.lastIndex=0;;){let r=cl.exec(n),a=cl.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){hh(t,c===void 0?new hl(o,i,e):new ul(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new dl(o),hh(t,u)),t=u}}}var $i=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);wm(r,a,this)}}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function uh(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var Cm=37297,Rm=0;function Pm(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var dh=new Ne;function Im(i){We._getMatrix(dh,We.workingColorSpace,i);let e=`mat3( ${dh.elements.map(t=>t.toFixed(4))} )`;switch(We.getTransfer(i)){case ds:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return we("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function fh(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+Pm(i.getShaderSource(e),o)}else return r}function Dm(i,e){let t=Im(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Lm(i,e){let t;switch(e){case jr:t="Linear";break;case Qr:t="Reinhard";break;case ea:t="Cineon";break;case Wi:t="ACESFilmic";break;case na:t="AgX";break;case ia:t="Neutral";break;case ta:t="Custom";break;default:we("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Ha=new D;function Um(){We.getLuminanceCoefficients(Ha);let i=Ha.x.toFixed(4),e=Ha.y.toFixed(4),t=Ha.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Om(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ws(i){return i!==""}function ph(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function mh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Bm=/^[ \t]*#include +<([\w\d./]+)>/gm;function fl(i){return i.replace(Bm,Vm)}var zm=new Map;function Vm(i,e){let t=Fe[e];if(t===void 0){let n=zm.get(e);if(n!==void 0)t=Fe[n],we('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return fl(t)}var km=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xh(i){return i.replace(km,Gm)}function Gm(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function gh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Hm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Bo?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===gc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(e="SHADOWMAP_TYPE_VSM"),e}function Wm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case di:e="ENVMAP_TYPE_CUBE";break;case Os:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Xm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case di:e="ENVMAP_MODE_REFRACTION";break}return e}function qm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ko:e="ENVMAP_BLENDING_MULTIPLY";break;case Fc:e="ENVMAP_BLENDING_MIX";break;case Oc:e="ENVMAP_BLENDING_ADD";break}return e}function Ym(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Zm(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=Hm(t),c=Wm(t),h=Xm(t),u=qm(t),f=Ym(t),p=Nm(t),x=Fm(r),_=s.createProgram(),m,d,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);let M=S+m+a,A=S+d+o,w=uh(s,s.VERTEX_SHADER,M),T=uh(s,s.FRAGMENT_SHADER,A);s.attachShader(_,w),s.attachShader(_,T),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(I){if(i.debug.checkShaderErrors){let F=s.getProgramInfoLog(_)||"",V=s.getShaderInfoLog(w)||"",W=s.getShaderInfoLog(T)||"",H=F.trim(),Y=V.trim(),j=W.trim(),G=!0,ne=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,w,T);else{let re=fh(s,w,"vertex"),Me=fh(s,T,"fragment");Oe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};var Wt=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}},U0=new Gi(-1,1,1,-1,0,1),yl=class extends mt{constructor(){super(),this.setAttribute("position",new Ye([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Ye([0,2,0,0,2,0],2))}},N0=new yl,Kn=class{constructor(e){this._mesh=new pt(N0,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,U0)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}};var $a=class extends Wt{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof et?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Pn.clone(e.uniforms),this.material=new et({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Kn(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};var Xs=class extends Wt{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}},Ka=class extends Wt{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}};var ja=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new me);this._width=n.width,this._height=n.height,t=new wt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ht}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new $a(ji),this.copyPass.material.blending=Jt,this.clock=new hi}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let s=0,r=this.passes.length;s<r;s++){let a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){let o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Xs!==void 0&&(a instanceof Xs?n=!0:a instanceof Ka&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new me);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}};var Qa=class extends Wt{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Le}render(e,t,n){let s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}};var Rh={name:"LuminosityHighPassShader",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Le(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Qi.BlurDirectionX=new me(1,0);Qi.BlurDirectionY=new me(0,1);var qs={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
...
`;var O0=["canvasHost"],B0=8,z0=2,V0=1.25,Dn=9.4,k0=4643210,Bh=6269183,G0=10134706,bl=16757337,zh=class i{canvasHost;data=ts(kl);narrative=ts(zl);wm=ts(Gl);i18n=ts(Vl);hovered=Pl(null);scene;camera;renderer;composer;bloom;controls;raycaster=new Ns;pointer=new me;world=new hn;markers=[];rings=[];clocks=[];core;hoverGroup=null;downAt=null;frame=0;clock=new hi;reduced=!1;onResize=()=>this.resize();ngAfterViewInit(){this.reduced=this.narrative.prefersReducedMotion();try{this.init(),this.buildPlanet(),this.buildRings(),this.buildMarkers(),this.animate(),window.addEventListener("resize",this.onResize)}catch{this.exit()}}init(){let e=this.canvasHost.nativeElement,t=e.clientWidth||window.innerWidth,n=e.clientHeight||window.innerHeight,s=Math.min(window.devicePixelRatio,z0);this.scene=new ys,this.camera=new Et(50,t/n,.1,500),this.camera.position.set(0,7,34),this.renderer=new Xa({antialias:!1,alpha:!0,powerPreference:"high-performance"}),this.renderer.setSize(t,n),this.renderer.setPixelRatio(s),this.renderer.toneMapping=Wi,this.renderer.toneMappingExposure=.92,e.appendChild(this.renderer.domElement);try{this.composer=new ja(this.renderer),this.composer.setPixelRatio(Math.min(s,V0)),this.composer.setSize(t,n),this.composer.addPass(new Qa(this.scene,this.camera)),this.bloom=new Qi(new me(t,n),.62,.55,.72),this.composer.addPass(this.bloom),this.composer.addPass(new eo)}catch{this.composer=void 0}this.controls=new Ja(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.045,this.controls.rotateSpeed=.55,this.controls.enablePan=!1,this.controls.minDistance=17,this.controls.maxDistance=62,this.controls.autoRotate=!this.reduced,this.controls.autoRotateSpeed=.32,this.scene.add(this.world),this.buildStars()}buildStars(){let t=new Float32Array(7800),n=new Float32Array(2600);for(let a=0;a<2600;a++){let o=95+Math.random()*150,l=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1);t[a*3]=o*Math.sin(c)*Math.cos(l),t[a*3+1]=o*Math.cos(c),t[a*3+2]=o*Math.sin(c)*Math.sin(l),n[a]=Math.random()<.07?2.4:.8}let s=new mt;s.setAttribute("position",new At(t,3)),s.setAttribute("aSize",new At(n,1));let r={uTime:{value:0}};this.clocks.push(r.uTime),this.scene.add(new Ss(s,new et({transparent:!0,depthWrite:!1,uniforms:r,vertexShader:`
        ...
        }`})))}buildPlanet(){this.core={uTime:{value:0},uHit:{value:new D},uHitAt:{value:-100}},this.clocks.push(this.core.uTime);let e=new pt(new Cs(Dn,48),new et({uniforms:this.core,vertexShader:Ph,fragmentShader:Ih}));e.name="CORE",this.world.add(e),this.world.add(new Ms(this.graticule(Dn*1.003,12,8),new Vi({color:9413816,transparent:!0,opacity:.42,blending:sn,depthWrite:!1})));let t={uTime:{value:0}};this.clocks.push(t.uTime),this.world.add(new pt(new ki(Dn*1.12,64,48),new et({uniforms:t,vertexShader:Dh,fragmentShader:Lh,transparent:!0,side:Mt,depthWrite:!1,blending:sn})))}buildRings(){let e=[[Dn*1.55,1.16,.22,.09],[Dn*1.92,.72,-.42,-.06],[Dn*2.45,1.42,.58,.04]],t=[bl,Bh,bl];e.forEach(([n,s,r,a],o)=>{let l={uTime:{value:0},uColor:{value:new Le(t[o])},uSpeed:{value:a}};this.clocks.push(l.uTime);let c=new pt(new Ds(n,.022,3,240),new et({uniforms:l,vertexShader:Uh,fragmentShader:Nh,transparent:!0,depthWrite:!1,blending:sn}));c.rotation.set(s,0,r),this.rings.push(c),this.world.add(c)})}graticule(e,t,n){let s=[];for(let o=0;o<t;o++){let l=o/t*Math.PI*2;for(let c=0;c<64;c++)for(let h of[c,c+1]){let u=h/64*Math.PI-Math.PI/2;s.push(e*Math.cos(u)*Math.cos(l),e*Math.sin(u),e*Math.cos(u)*Math.sin(l))}}for(let o=1;o<n;o++){let l=o/n*Math.PI-Math.PI/2,c=e*Math.cos(l),h=e*Math.sin(l);for(let u=0;u<64;u++)for(let f of[u,u+1]){let p=f/64*Math.PI*2;s.push(c*Math.cos(p),h,c*Math.sin(p))}}let a=new mt;return a.setAttribute("position",new Ye(s,3)),a}buildMarkers(){let e=this.data.projects(),t=this.fibonacci(e.length);e.forEach((n,s)=>{let r=n.status==="PRODUCTION"||n.status==="DELIVERED"?k0:n.status==="PROTOTYPE"||n.status==="ARCHIVED"?G0:Bh;this.markers.push(this.beacon(t[s].lat,t[s].lon,n,r,s))})}fibonacci(e){if(e===1)return[{lat:12,lon:0}];let t=Math.PI*(3-Math.sqrt(5)),n=[];for(let s=0;s<e;s++){let r=1-(s+.5)/e*2,a=Math.asin(Math.max(-1,Math.min(1,r)))*(180/Math.PI),o=t*s*(180/Math.PI)%360-180;n.push({lat:a*.8,lon:o})}return n}beacon(e,t,n,s,r){let a=new hn,o=(90-e)*(Math.PI/180),l=(t+180)*(Math.PI/180),c=new D(-(Dn*Math.sin(o)*Math.cos(l)),Dn*Math.cos(o),Dn*Math.sin(o)*Math.sin(l));a.position.copy(c),a.quaternion.setFromUnitVectors(new D(0,1,0),c.clone().normalize());let h=new Le(s),u={uTime:{value:0},uColor:{value:h.clone()},uSeed:{value:r*1.7}};this.clocks.push(u.uTime);let f=new pt(new As(.1,.3,3.4,10,1,!0),new et({uniforms:u,vertexShader:Fh,fragmentShader:Oh,transparent:!0,depthWrite:!1,side:Gt,blending:sn}));f.position.y=1.7,f.name="BEAM",a.add(f);let p=new pt(new Rs(.36,0),new nn({color:h,wireframe:!0}));p.position.y=2.2,p.name="HEAD",a.add(p);let x=new pt(new ki(.13,12,10),new nn({color:16777215}));x.position.y=2.2,x.name="SPARK",a.add(x);let _=new pt(new Is(.32,.44,28),new nn({color:h,side:Gt,transparent:!0,opacity:.9,blending:sn,depthWrite:!1}));return _.rotation.x=Math.PI/2,_.position.y=.05,_.name="PAD",a.add(_),a.userData={isMarker:!0,project:n,base:s},this.world.add(a),a}pick(e,t){let n=this.renderer.domElement.getBoundingClientRect();this.pointer.x=(e-n.left)/n.width*2-1,this.pointer.y=-((t-n.top)/n.height)*2+1,this.raycaster.setFromCamera(this.pointer,this.camera);let s=this.raycaster.intersectObjects(this.world.children,!0);for(let r of s){let a=r.object;for(;a&&a!==this.world;){if(a.userData?.isMarker)return a;a=a.parent}}return null}onPointerMove(e){if(e.pointerType==="touch")return;let t=this.pick(e.clientX,e.clientY);t!==this.hoverGroup&&(this.hoverGroup&&this.mark(this.hoverGroup,this.hoverGroup.userData.base,1),t&&this.mark(t,bl,1.75),this.hoverGroup=t,this.hovered.set(t?t.userData.project.name:null))}mark(e,t,n){e.traverse(s=>{s instanceof pt&&(s.name==="HEAD"||s.name==="PAD")&&(s.material.color.setHex(t),s.scale.setScalar(n))})}onPointerDown(e){this.downAt={x:e.clientX,y:e.clientY}}onPointerUp(e){let t=this.downAt;if(this.downAt=null,!t||Math.hypot(e.clientX-t.x,e.clientY-t.y)>B0)return;let n=this.pick(e.clientX,e.clientY);if(n){this.controls.autoRotate=!1,this.wm.open(n.userData.project);return}let s=this.raycaster.intersectObjects(this.world.children,!0).find(r=>r.object.name==="CORE");if(s&&this.core){let r=s.point.clone().applyMatrix4(s.object.matrixWorld.clone().invert());this.core.uHit.value.copy(r),this.core.uHitAt.value=this.clock.getElapsedTime()}}exit(){this.narrative.setPhase("INTERFACE")}resize(){let e=this.canvasHost?.nativeElement;if(!e||!this.renderer)return;let t=e.clientWidth||window.innerWidth,n=e.clientHeight||window.innerHeight;this.camera.aspect=t/n,this.camera.updateProjectionMatrix(),this.renderer.setSize(t,n),this.composer?.setSize(t,n),this.bloom?.setSize(t,n)}animate=()=>{this.frame=requestAnimationFrame(this.animate);let e=this.clock.getElapsedTime();for(let t of this.clocks)t.value=e;this.reduced||(this.markers.forEach((t,n)=>{let s=t.getObjectByName("HEAD"),r=t.getObjectByName("SPARK");s&&(s.rotation.y+=.016,s.position.y=2.2+Math.sin(e*2.2+n*.9)*.15,r&&(r.position.y=s.position.y))}),this.rings.forEach((t,n)=>{t.rotation.y+=.0016*(n+1)*(n%2?-1:1)})),this.controls.update(),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)};ngOnDestroy(){cancelAnimationFrame(this.frame),window.removeEventListener("resize",this.onResize),this.controls?.dispose(),this.scene?.traverse(e=>{let t=e;t.geometry?.dispose?.();let n=t.material;Array.isArray(n)?n.forEach(s=>s.dispose()):n?.dispose?.()}),this.composer?.dispose?.(),this.renderer?.dispose(),this.renderer?.domElement.remove()}static \u0275fac=function(t){return new(t||i)};static \u0275cmp=Il({type:i,selectors:[["app-holo-rebirth"]],viewQuery:function(t,n){if(t&1&&Ll(O0,5),t&2){let s;Ul(s=Nl())&&(n.canvasHost=s.first)}},decls:26,vars:10,consts:[["canvasHost",""],[1,"orbit"],[1,"canvas",3,"pointerdown","pointerup","pointermove"],[1,"hud"],[1,"hud-tl"],[1,"o-title"],[1,"legend"],["aria-hidden","true",1,"k","live"],["aria-hidden","true",1,"k","work"],["aria-hidden","true",1,"k","arch"],["type","button",1,"btn","o-exit",3,"click"],[1,"hints"],["aria-live","polite",1,"readout"]],template:function(t,n){if(t&1){let s=Dl();on(0,"div",1)(1,"div",2,0),so("pointerdown",function(a){return ns(s),is(n.onPointerDown(a))})("pointerup",function(a){return ns(s),is(n.onPointerUp(a))})("pointermove",function(a){return ns(s),is(n.onPointerMove(a))}),ln(),on(3,"div",3)(4,"div",4)(5,"h1",5),xn(6),ln(),on(7,"ul",6)(8,"li"),$s(9,"span",7),xn(10),ln(),on(11,"li"),$s(12,"span",8),xn(13),ln(),on(14,"li"),$s(15,"span",9),xn(16),ln()()(),on(17,"button",10),so("click",function(){return ns(s),is(n.exit())}),xn(18),ln(),on(19,"p",11)(20,"span"),xn(21),ln(),on(22,"span"),xn(23),ln()(),on(24,"p",12),xn(25),ln()()()}t&2&&(an(6),Ln(n.i18n.t().orbitView),an(4),Ln(n.i18n.t().legendLive),an(3),Ln(n.i18n.t().legendWeb),an(3),Ln(n.i18n.t().legendGame),an(2),Ol(" ",n.i18n.t().orbitExit," "),an(3),Ln(n.i18n.t().hintDrag),an(2),Ln(n.i18n.t().hintTap),an(),Fl("on",n.hovered()),an(),Ln(n.hovered()))},dependencies:[Bl],styles:[".orbit[_ngcontent-%COMP%]{position:fixed;inset:0;background:radial-gradient(1000px 700px at 50% 55%,rgba(255,178,89,.05),transparent 62%),var(--void);overflow:hidden}.canvas[_ngcontent-%COMP%]{position:absolute;inset:0;touch-action:none;cursor:grab}.canvas[_ngcontent-%COMP%]:active{cursor:grabbing}.canvas[_ngcontent-%COMP%]   canvas[_ngcontent-%COMP%]{display:block}.hud[_ngcontent-%COMP%]{position:absolute;inset:0;pointer-events:none;padding:var(--sp-5);animation:_ngcontent-%COMP%_hud-in .7s var(--ease-out) .2s backwards}@keyframes _ngcontent-%COMP%_hud-in{0%{opacity:0}}.hud-tl[_ngcontent-%COMP%]{position:absolute;inset-block-start:var(--sp-5);inset-inline-start:var(--sp-5)}.o-title[_ngcontent-%COMP%]{font-family:var(--mono);font-size:var(--t-sm);font-weight:500;letter-spacing:.18em;color:var(--signal);margin-block-end:var(--sp-4)}.legend[_ngcontent-%COMP%]{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:7px}.legend[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]{display:flex;align-items:center;gap:9px;font-family:var(--mono);font-size:var(--t-micro);letter-spacing:.09em;color:var(--text-mute)}.legend[_ngcontent-%COMP%]   .k[_ngcontent-%COMP%]{inline-size:7px;block-size:7px;border-radius:50%;flex-shrink:0}.legend[_ngcontent-%COMP%]   .live[_ngcontent-%COMP%]{background:var(--live)}.legend[_ngcontent-%COMP%]   .work[_ngcontent-%COMP%]{background:var(--work)}.legend[_ngcontent-%COMP%]   .arch[_ngcontent-%COMP%]{background:var(--arch)}.o-exit[_ngcontent-%COMP%]{position:absolute;inset-block-start:var(--sp-5);inset-inline-end:var(--sp-5);pointer-events:auto}.hints[_ngcontent-%COMP%]{position:absolute;inset-block-end:var(--sp-5);inset-inline:0;display:flex;flex-direction:column;align-items:center;gap:4px;margin:0;font-family:var(--mono);font-size:var(--t-micro);letter-spacing:.14em;color:var(--text-mute)}.readout[_ngcontent-%COMP%]{position:absolute;inset-block-end:calc(var(--sp-5) + 52px);inset-inline:0;margin:0;text-align:center;font-family:var(--mono);font-size:var(--t-sm);font-weight:600;letter-spacing:.12em;color:var(--signal);opacity:0;transform:translateY(5px);transition:opacity var(--dur-ui) var(--ease-out),transform var(--dur-ui) var(--ease-out)}.readout.on[_ngcontent-%COMP%]{opacity:1;transform:translateY(0)}@media (max-width: 760px){.hud[_ngcontent-%COMP%]{padding:var(--sp-3)}.hud-tl[_ngcontent-%COMP%], .o-exit[_ngcontent-%COMP%]{inset-block-start:var(--sp-3)}.hud-tl[_ngcontent-%COMP%]{inset-inline-start:var(--sp-3)}.o-exit[_ngcontent-%COMP%]{inset-inline-end:var(--sp-3)}.legend[_ngcontent-%COMP%]{display:none}}@media (prefers-reduced-motion: reduce){.hud[_ngcontent-%COMP%]{animation:none}.readout[_ngcontent-%COMP%]{transition:none}}"]})};export{zh as HoloRebirthComponent};
